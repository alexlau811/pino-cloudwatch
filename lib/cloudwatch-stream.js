...
function CloudWatchStream(options) {
  ...
  if (options.aws_region || options.aws_access_key_id || options.aws_secret_access_key || options.aws_profile) {
    awsOptions = {
      credentials: ( options.aws_access_key_id && options.aws_secret_access_key ) ? {
